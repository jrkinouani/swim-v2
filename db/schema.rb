...
ActiveRecord::Schema.define(version: 20181106120550) do
  ...
  create_table "reservationboxes", force: :cascade do |t|
    t.integer "price"
    t.date "start"
    t.string "phone"
    t.string "name"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["aquaboxing_id"], name: "index_reservationboxes_on_aquaboxing_id"
  end
